...
SC08_18_sp <- st_as_sf(SC08_18, coords= c("Longitude", "Latitude"), crs= " +proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0")
...
pointWidth<-c(2,3,4,5,6,7,8)[Points_Crime_08$Harm.Index]
pointWidth

pointPalette<-c("purple", "green", "red", "orange")
pointPalette

crimeTypeColor<-c("purple", "green", "red","orange")[Points_Crime_08$Crime.type]
crimeTypeColor

osm_base<- read_osm(COL_buldings, type="esri", zoom=NULL)
qtm(osm_base)+
...
plot (Points_Crime_08, col=crimeTypeColor, main="Crime type\n City of London", lwd=pointWidth)
