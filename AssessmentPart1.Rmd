...
The idea behind these studies comes to produce two maps using the POLICE.UK street-crimes data (https://data.police.uk/). The first spatial representation consists in comparing the street crimes and the Underground Stations and the second takes into consideration the evolution in terms of trends from 2015 to 2018. For this purpose the “Police.uk” web-site provides a large quantity of data in CSV format related to the street-level crime. Particularly in this case, the London Metropolitan Police service was used to download the csv file which is released monthly from September 2015 to August 2018. Along with the Police data, other Open Street Map shapefiles were used as cartographic base for the overall process.


##Visualizing The London Metropolitan Police street-crime data compared to the Underground Stations as August 2018.
