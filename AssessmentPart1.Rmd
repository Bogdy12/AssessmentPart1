...
A new project named "Urbanisation.qgis" has been saved into the local folder and after setting the coordinates reference system through the "Project Properties>CRS>WGS 84/Pseudo Mercator - ESPG:3857" which is the most familiar in representations, also used extensively by Google, both the shapefiles were added as vector layers into the project. 
