...
The CLI evironment
benefits: exporting different s files is very easy after learning some basic code, drawing grapgh from csv file, shapefile is very quick, reading the CRS is very quick in R
